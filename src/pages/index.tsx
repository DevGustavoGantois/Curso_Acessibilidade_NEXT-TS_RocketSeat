      ...
      <Head>
        ...
        <header className={styles.header}>
            ...
            <nav className={styles.nav}>
              <a href="https://github.com/DevGustavoGantois" target="_blank">
        ...
        <article className={styles.content}>
          ...
          <p>Acessibilidade se tornou tendência no ecossistema tecnologico mundial, diversas empresas passaram a adotar crtérios de níveis de acessibilidade</p>

          <p>Para abordar este tema, é preciso ter uma perspectiva cultural sobre o assunto, não encará-lo apenas na ótica técnica ou prática</p>

          <h2>O que é acessbilidade a final?</h2>
        </article>
        </main>
